<template>
  <div class="wraper" ref="wraper">
    ...
    <div class="download">
      <button type="button" :disabled="done" @click="downLoadImage">下载为png</button>
  ...
  export default{
    data() {
      return{
        ...
        toolsArr: [
          {
            name: 'pencil',
            icon: require('./assets/icons/draw/7.png')
          },
          {
            name: 'line',
            icon: require('./assets/icons/draw/1.png')
          },
          {
            name: 'arrow',
            icon: require('./assets/icons/draw/2.png')
          },
          {
            name: 'dashedline',
            icon: require('./assets/icons/draw/9.png')
          },
          {
            name: 'rectangle',
            icon: require('./assets/icons/draw/4.png')
          },
          {
            name: 'text',
            icon: require('./assets/icons/draw/5.png')
          },
          {
            name: 'circle',
            icon: require('./assets/icons/draw/3.png')
          },
          {
            name: 'ellipse',
            icon: require('./assets/icons/draw/8.png')
          },
          {
            name: 'triangle', //三角形
          ...
          {
            name: 'undo',
            icon: require('./assets/icons/draw/undo.png')
          },
          {
            name: 'redo',
            icon: require('./assets/icons/draw/redo.png')
          },
          {
            name: 'reset',
    ...
    methods:{
      ...
      initCanvas() {
        ...
        this.fabricObj.freeDrawingBrush.color = '#2b73af'
        this.fabricObj.freeDrawingBrush.width = 2
        this.fabricObj.setWidth(this.canvasWidth)
        this.fabricObj.setHeight(500)
        this.fabricObj.add(
          new fabric.Rect({ top: 100, left: 500, width: 100, height: 50, fill: 'blue' }),
          new fabric.Circle({ top: 140, left: 500, radius: 75, fill: 'red' }),
          new fabric.Triangle({ top: 200, left: 560, width: 100, height: 100, fill: 'green' }),
        )
        //绑定画板事件
